...
DP_OPERATIONS = [
('zero' , pattern((('op', 'zero'), ('rd', register())), can_have_label=True),                                                       "zero rd            -->  $rd := 0",                          lambda m, params : '0000'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'00000000' ), # TODO: extra zero??
('not'  , pattern((('op', 'not'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "not rd rs          -->  $rd := ! $rs",                      lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0001' ),
('inv'  , pattern((('op', 'inv'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "inv rd rs          -->  $rd := - $rs",                      lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1010' ),
('sll'  , pattern((('op', 'sll'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sll rd rs          -->  $rd := $rs << 2",                   lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1011' ),
('srl'  , pattern((('op', 'srl'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "srl rd rs          -->  $rd := $rs >> 2",                   lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1100' ),
('sla'  , pattern((('op', 'sla'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sla rd rs          -->  $rd := $rs * 2",                    lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1101' ),
('sra'  , pattern((('op', 'sra'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sra rd rs          -->  $rd := $rs / 2",                    lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1110' ),
('cp'   , pattern((('op', 'cp'),   ('rd', register()), ('rs', register())), can_have_label=True),                                   "cp rd rs           -->  $rd := $rs",                        lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'1111' ),
('and'  , pattern((('op', 'and'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "and rd rs rt       -->  $rd := $rs & $rt",                  lambda m, params : '0010'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('or'   , pattern((('op', 'or'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "or rd rs rt        -->  $rd := $rs | $rt",                  lambda m, params : '0011'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('add'  , pattern((('op', 'add'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "add rd rs rt       -->  $rd := $rs + $rt",                  lambda m, params : '0100'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('sub'  , pattern((('op', 'sub'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "sub rd rs rt       -->  $rd := $rs - $rt",                  lambda m, params : '0101'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lt'   , pattern((('op', 'lt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "lt rd rs rt        -->  $rs < $rt ? $rd := 1 : $rd := 0",   lambda m, params : '0110'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('gt'   , pattern((('op', 'gt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "gt rd rs rt        -->  $rs > $rt ? $rd := 1 : $rd := 0",   lambda m, params : '0111'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('eq'   , pattern((('op', 'eq'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "eq rd rs rt        -->  $rs = $rt ? $rd := 1 : $rd := 0",   lambda m, params : '1000'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('neq'  , pattern((('op', 'neq'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "neq rd rs rt       -->  $rs != $rt ? $rd := 1 : $rd := 0",  lambda m, params : '1001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lw'   , pattern((('op', 'lw'),   ('rd', register()), ('rs', register()), ('uimm', uintegerpattern())), can_have_label=True),      "lw rd rs uimm      -->  $rd := MEM[$rs + uimm]",            lambda m, params : '1010'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('uimm'),4)) ),
('sw'   , pattern((('op', 'sw'),   ('rd', register()), ('rs', register()), ('uimm', uintegerpattern())), can_have_label=True),      "sw rd rs uimm      -->  MEM[$rs + uimm] := $rd",            lambda m, params : '1011'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('uimm'),4)) ),
('ldi'  , pattern((('op', 'ldi'),  ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "ldi rd imm     -->  rd := imm",                    lambda m, params : '1100'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm')),
('ldi'  , pattern((('op', 'ldi'),  ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "ldi rd imm     -->  rd := imm",                    lambda m, params : '1100'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),8))),
('addi' , pattern((('op', 'addi'), ('rd', register()), ('rs', register()), ('imm', binarypattern(4))), can_have_label=True),        "addi rd rs imm -->  rd := rs + imm",               lambda m, params : '1101'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+m.group('imm')),
('addi' , pattern((('op', 'addi'), ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "addi rd rs imm -->  rd := rs + imm",               lambda m, params : '1101'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),4))),
]

# extra full data path operations
# (name, parse_pattern, help_string, compile_function)
FULL_DP_OPERATIONS = [
('beq'  , pattern((('op', 'beq'),  ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "beq rd rs imm   -->  rd==rs ? pc := pc+1+imm",     lambda m, params : '1110'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),4)) ),
('beq'  , pattern((('op', 'beq'),  ('rd', register()), ('rs', register()), ('to', labelpattern())), can_have_label=True),           "beq rd rs imm   -->  rd==rs ? pc := pc+1+imm",     lambda m, params : '1110'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),4,params[1],params[0]-1)) ),
('blt'  , pattern((('op', 'blt'),  ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "blt rd rs imm   -->  rd<rs ? pc := pc+1+imm",      lambda m, params : '1111'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),4)) ),
('blt'  , pattern((('op', 'blt'),  ('rd', register()), ('rs', register()), ('to', labelpattern())), can_have_label=True),           "blt rd rs imm   -->  rd<rs ? pc := pc+1+imm",      lambda m, params : '1111'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'0'+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),4,params[1],params[0]-1)) ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', binarypattern(4))), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm')+'0010' ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),4))+'0010' ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('to', labelpattern())), can_have_label=True),                               "jr rd imm       -->  pc := rd+imm",                lambda m, params : '0001'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),4,params[1]))+'0010' ),
